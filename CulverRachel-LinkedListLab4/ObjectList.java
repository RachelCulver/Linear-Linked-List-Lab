...
/**
 * Creates and maintains a linear linked list.
 * 
...
public class ObjectList implements ObjectListInterface{
     ...
     * 
     * @param p  ObjectListNode node to be added to list 
     */
     ...
     * 
     * @param p ObjectListNode added to list
     */
    ...
    /**
     * Inserts a node afger the node referenced by p
     * 
     * @param p - ObjectListNode
     * @param o - Object
     */
    ...
    /**
     * Returns a reference to the node with the requested value or returns null otherwise
     * 
     * @returns  reference to the node with the requested value or null
     */
